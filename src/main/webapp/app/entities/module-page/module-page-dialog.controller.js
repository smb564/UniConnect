(function() {
    ...
    ModulePageDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'ModulePage', 'DEPARTMENTS'];

    function ModulePageDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, ModulePage, DEPARTMENTS) {
        var vm = this;
        ...
        function save () {
            ...
            if (vm.modulePage.id !== null) {
                ...
                ModulePage.save(vm.modulePage, onSaveSuccess, onSaveError);
            }
        }
